...
import com.ckz.qrcodescan.zxing.app.PreferencesActivity;
import com.ckz.qrcodescan.zxing.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	 ...
	 */
	public void openDriver(SurfaceTexture holder, int width, int height) throws IOException {
		if (camera == null) {
			camera = Camera.open();
			if (camera == null) {
